...
class LastFmUser(models.Model):
    ...
    total_artists = models.CharField(max_length=30, blank=True)
    total_loved_tracks = models.CharField(max_length=30, blank=True)
    total_pages = models.CharField(max_length=30, blank=True)
